...
int DBG_XCB, DBG_ATOM, DBG_WIN, DBG_PROP;
int DBG_EXEC, DBG_FUNC, DBG_SEQ, DBG_RESOLV, DBG_TRACK, DBG_XV;
...
static void plugin_init(OhmPlugin *plugin)
{
    ...
    DBG_XCB = DBG_ATOM = DBG_WIN = DBG_PROP = TRUE;
    DBG_EXEC = DBG_FUNC = DBG_SEQ = DBG_RESOLV = DBG_TRACK = DBG_XV  = TRUE;
#endif
